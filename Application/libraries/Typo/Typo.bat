...
rem Created by kvc
rem :: batchprogrammers.blogspot.com

rem [%~1] : Font file to load...[Learn to create font files at batchprogrammers.blogspot.com]
REM [%~2] : x_POS of text...
rem [%~3] : y_POS of text...
...
Echo.
Echo. For more, visit: Https://batchprogrammers.blogspot.com
Echo. #TheBATeam
Echo.
Exit /b 0
